...
push-8.8.1-xenial-slim : .build/8.8.1-xenial-slim
	docker push phadej/ghc:8.8.1-xenial-slim
...
push-8.8.1-xenial : .build/8.8.1-xenial
	docker push phadej/ghc:8.8.1-xenial
...
push-8.8.1-bionic-slim : .build/8.8.1-bionic-slim
	docker push phadej/ghc:8.8.1-bionic-slim
...
push-8.8.1-bionic : .build/8.8.1-bionic
	docker push phadej/ghc:8.8.1-bionic
...
.build/8.8.1-xenial-slim : .build
	docker build -t phadej/ghc:8.8.1-xenial-slim 8.8.1/xenial/slim
	touch .build/8.8.1-xenial-slim
...
.build/8.8.1-xenial : .build
	docker build -t phadej/ghc:8.8.1-xenial 8.8.1/xenial
	touch .build/8.8.1-xenial
...
.build/8.8.1-bionic-slim : .build
	docker build -t phadej/ghc:8.8.1-bionic-slim 8.8.1/bionic/slim
	touch .build/8.8.1-bionic-slim
...
.build/8.8.1-bionic : .build
	docker build -t phadej/ghc:8.8.1-bionic 8.8.1/bionic
	touch .build/8.8.1-bionic
